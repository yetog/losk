...
export const characterData: Record<string, Character> = {
  ...
  liora: {
    ...
    species: 'Fairy',
    icon: '🧚',
    portrait: '/losk/images/characters/Liora.jpg',
  ...
  kingfasa: {
    ...
    species: 'Beast',
    icon: '🦁',
    portrait: '/losk/images/characters/Fasa.jpg',
  ...
  kira: {
    ...
    species: 'Elf',
    icon: '⚔️',
    portrait: '/losk/images/characters/Kira.jpg',
    imagePosition: 'center 15%',
  ...
  bradley: {
    ...
    species: 'Human',
    icon: '🔫',
    portrait: '/losk/images/characters/Bradley.jpg',
    imagePosition: 'center 20%',
  ...
  dante: {
    ...
    species: 'Elf',
    icon: '🗡️',
    portrait: '/losk/images/characters/Dante.jpg',
    imagePosition: 'center 20%',
